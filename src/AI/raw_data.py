...
def catCols(gender, marital, university, ocupation, children):
    cat_cols = pd.DataFrame({'Gender': gender, 'Marital_Status': marital, 'University': university, 'Ocupation': ocupation, 'Children': children})
    return cat_cols
